...
type ProductServiceClient interface {
	...
	List(ctx context.Context, in *Filters, opts ...grpc.CallOption) (*ListResponse, error)
}
...
func (c *productServiceClient) List(ctx context.Context, in *Filters, opts ...grpc.CallOption) (*ListResponse, error) {
...
type ProductServiceServer interface {
	...
	List(context.Context, *Filters) (*ListResponse, error)
...
func (UnimplementedProductServiceServer) List(context.Context, *Filters) (*ListResponse, error) {
...
func _ProductService_List_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProductServiceServer).List(ctx, req.(*Filters))
	}
	return interceptor(ctx, in, info, handler)
}
